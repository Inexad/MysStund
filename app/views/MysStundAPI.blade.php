...
<div class="jumbotron">
    <div class="container">
        ...
        <div class="row">
            <h3>MysStund</h3>
            <p>Beroende på vad som skickas som parameterar så genereras ett svar i json tillbaka. Alla parametrar måste vara med annars kommer ett felmeddelande att förfrågan inte var korrekt.</p>

            <div class="row">
                <div class="alert alert-success" role="alert">
                    <h4> URL struktur:</h4>
                    <h5 id="urlrules">MysStund/API?price=<span class="alert-danger">pris</span>&gender=<span class="alert-danger">kön</span>&mood=<span class="alert-danger">humör</span></h5>
                </div>
            </div>
